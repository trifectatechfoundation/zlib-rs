...
pub unsafe fn back(
    ...
    'inf_leave: loop {
        ...
        match state.mode {
            Mode::Head | Mode::Flags | Mode::Time | Mode::Os => unreachable!(),
            ...
            Mode::Len => {
                ...
                // debug_assert_eq!(state.mode as u8, Mode::Len as u8);
                continue 'inf_leave;
            }
            Mode::Done => {
