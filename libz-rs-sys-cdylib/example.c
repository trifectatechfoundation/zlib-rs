/* .c -- usage example of the zlib compression library
 * Copyright (C) 1995-2006, 2011, 2016 Jean-loup Gailly
 * For conditions of distribution and use, see copyright notice in zlib.h
 */

// This version of the file is from the zlib-ng repository. The imports/defines have been
// changed slightly, but otherwise these are the same tests.

#include "zlib.h"

// Use the zlib types/signatures (not the zlib-ng types/signatures).
# define ZLIB_COMPAT 1

#  define PREFIX(x) x
#  define PREFIX3(x) z_ ## x
#  define Z_UNUSED(x)
typedef unsigned long z_uintmax_t;
